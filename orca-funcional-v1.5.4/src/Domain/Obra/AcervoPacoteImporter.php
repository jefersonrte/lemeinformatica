 ...
 * padrão, orçamentos com itens e plantas no catálogo técnico. É idempotente: orçamentos são
 * reconhecidos pelo hash do arquivo de origem e plantas pelo nome e tamanho, então reenviar o
 * pacote só completa o que faltou.
 */
