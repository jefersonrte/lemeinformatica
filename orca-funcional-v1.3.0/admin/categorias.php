...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        error_log('[admin/categorias.php] ' . $exception->getMessage());
            ...
            <tr>
                ...
                <td>
                    <div class="td-actions">
                        <button class="btn btn-sm btn-outline" onclick='editarCat(<?= $cat['id'] ?>, <?= jsonAttr($cat['nome']) ?>, <?= jsonAttr($cat['descricao']) ?>, <?= jsonAttr($vMap[$cat['id']] ?? []) ?>)'>✏️</button>
