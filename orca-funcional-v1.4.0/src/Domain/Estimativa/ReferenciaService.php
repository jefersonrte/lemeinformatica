    ...
    public function importarReferencias(array $referencias, string $origem, ?int $orcamentoId = null): int
    {
        ...
        foreach ($referencias as $ref) {
            ...
            try {
                ...
                $linhas = array_map(static fn (array $i): array => [
                ...
                $this->inserirEmLotes('INSERT INTO referencia_itens (referencia_id, etapa, etapa_padrao, descricao, unidade, quantidade, preco_unitario) VALUES ', 7, $linhas);
                if ($propria) {
                    $this->db->commit();
                }
                $novas++;
