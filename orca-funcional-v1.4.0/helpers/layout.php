...
function sidebar(string $active = ''): void {
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav" aria-label="Módulos do sistema">
            ...
            <a href="<?= $base ?>/admin/previa_obra.php" class="nav-link <?= $active === 'previa' ? 'active' : '' ?>"><span class="icon"><i class="fa-solid fa-wand-magic-sparkles"></i></span> Prévia de obra</a>
            ...
            <a href="<?= $base ?>/admin/referencias.php" class="nav-link <?= $active === 'referencias' ? 'active' : '' ?>"><span class="icon"><i class="fa-solid fa-database"></i></span> Base de referência</a>
