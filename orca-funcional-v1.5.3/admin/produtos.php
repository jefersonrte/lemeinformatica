            ...
            <tr>
                ...
                <td>
                    <div class="td-actions">
                        <button class="btn btn-sm btn-outline" onclick='editarProduto(<?= jsonAttr($p) ?>)'>✏️</button>
...
function editarProduto(p) {
    ...
    const un = document.getElementById('fPUn');
    if (p.unidade && ![...un.options].some(o => o.value === p.unidade)) un.add(new Option(p.unidade, p.unidade));
    un.value = p.unidade || 'UN';
