...
$projects = [
    [
        'name' => 'Orçamentista',
        'description' => 'Versão atual recomendada: prévia de obra a partir da planta e da planilha, com materiais, quantidades e custo aproximado baseados em 42 orçamentos reais e no SINAPI.',
    ...
    <main>
        <section class="intro" aria-labelledby="page-title">
            ...
            <div class="intro-actions">
                <a class="primary-action" href="https://lemeinformatica.com.br/orca-funcional-v1.4.1/">Abrir Orçamentista v1.4.1</a>
