...
$projects = [
    [
        'name' => 'Orçamentista',
        'description' => 'Versão atual recomendada: junção das plantas da obra numa imagem única com animação, leitura das pranchas e download, além do acervo de obras de exemplo e da prévia de obra com base de 59 orçamentos reais e SINAPI.',
        'url' => 'https://lemeinformatica.com.br/orca-funcional-v1.5.4/',
    ...
    [
        ...
        'description' => 'Versão 1.5.3 preservada, com a importação do acervo de obras de exemplo (clientes fictícios, orçamentos reais e plantas).',
        'url' => 'https://lemeinformatica.com.br/orca-funcional-v1.5.3/',
        'category' => 'Orçamentos e obras',
        'module' => 'orca',
        'version' => 'v1.5.3',
        'status' => 'Histórico',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.5.2 preservada, com a prévia de várias pranchas e base de 59 orçamentos reais.',
        'url' => 'https://lemeinformatica.com.br/orca-funcional-v1.5.2/',
        'category' => 'Orçamentos e obras',
        'module' => 'orca',
        'version' => 'v1.5.2',
        'status' => 'Histórico',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.5.1 preservada, com o tema Grafite escuro como padrão e base de 42 orçamentos reais.',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.4.1 preservada, com a interface anterior e base de 42 orçamentos reais.',
        'url' => 'https://lemeinformatica.com.br/orca-funcional-v1.4.1/',
        'category' => 'Orçamentos e obras',
        'module' => 'orca',
        'version' => 'v1.4.1',
        'status' => 'Histórico',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.4.0 preservada, primeira com a prévia de obra.',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.2.4 preservada, com cadastro de obras corrigido e análise de categoria na planilha CAIXA.',
        'url' => 'https://lemeinformatica.com.br/orca-funcional-v1.2.4/',
        'category' => 'Orçamentos e obras',
        'module' => 'orca',
        'version' => 'v1.2.4',
        'status' => 'Histórico',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.2.3 preservada, com recuperação dos arquivos históricos e leitor SVG estável.',
    ...
    [
        'name' => 'Orçamentista funcional',
        'description' => 'Versão 1.2.1 preservada, anterior ao suporte de upload SVG.',
