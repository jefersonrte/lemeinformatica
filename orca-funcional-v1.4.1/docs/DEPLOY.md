...
| Produção atual | `/orca-funcional-v1.4.1/` | Versão funcional recomendada. |
| Histórico | `/orca-funcional-v1.4.0/`, `/orca-funcional-v1.3.0/`, `/orca-funcional-v1.2.4/`, `/orca-funcional-v1.2.3/`, `/orca-funcional-v1.2.2/`, `/orca-funcional-v1.2.1/`, `/orca-funcional-v1.2.0/`, `/orca-v1.2.0/`, `/orca/` | Versões anteriores preservadas para consulta/rollback. |
