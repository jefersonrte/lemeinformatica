...
Esta pasta é a fonte oficial de conhecimento da versão `1.4.1`. Ela descreve o sistema como ele está implementado no código, sem incluir credenciais, chaves, dados pessoais ou cópias do banco de produção.
