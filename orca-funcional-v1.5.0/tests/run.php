...
$assertSame(6, count(Theme::all()), 'temas: seis opções prontas');
$assertSame('grafite', Theme::resolve(null), 'temas: padrão sem cookie é o grafite');
$assertSame('noturno', Theme::resolve(' NOTURNO '), 'temas: normaliza caixa e espaços');
$assertSame('grafite', Theme::resolve('"><script>'), 'temas: rejeita valor desconhecido');
$assertSame('grafite', Theme::resolve(['canteiro']), 'temas: rejeita array');
