    ...
    <div class="modal">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="form-group"><label class="form-label" for="novaPlantaArquivo">Arquivo</label><input class="form-control" id="novaPlantaArquivo" type="file" name="arquivo" accept=".pdf,.png,.jpg,.jpeg,.webp" required><small class="form-help">PDF, PNG, JPG ou WEBP · até <?= UPLOAD_MAX_MB ?> MB</small></div>
            </div>
